...
#ifndef ____x_Gemini2API_CViews_CISettingsPage_FWD_DEFINED__
#define ____x_Gemini2API_CViews_CISettingsPage_FWD_DEFINED__
...
#define __x_Gemini2API_CViews_CISettingsPage Gemini2API::Views::ISettingsPage

#endif // ____x_Gemini2API_CViews_CISettingsPage_FWD_DEFINED__
...
/*
 *
 * Interface Gemini2API.Views.ISettingsPage
 *
 * Interface is a part of the implementation of type Gemini2API.Views.SettingsPage
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Gemini2API.Views.ISettingsPage:
 *
 *
 */
#if !defined(____x_Gemini2API_CViews_CISettingsPage_INTERFACE_DEFINED__)
#define ____x_Gemini2API_CViews_CISettingsPage_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_Views_ISettingsPage[] = L"Gemini2API.Views.ISettingsPage";

namespace Gemini2API {
    namespace Views {
        /* [uuid("a54af139-1718-5f75-b108-13c0d3dd02d1"), version, object, exclusiveto] */
        MIDL_INTERFACE("a54af139-1718-5f75-b108-13c0d3dd02d1")
...
EXTERN_C const IID IID___x_Gemini2API_CViews_CISettingsPage;
#endif /* !defined(____x_Gemini2API_CViews_CISettingsPage_INTERFACE_DEFINED__) */


/*
 *
 * Class Gemini2API.Views.SettingsPage
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Gemini2API.Views.ISettingsPage ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Gemini2API_Views_SettingsPage_DEFINED
#define RUNTIMECLASS_Gemini2API_Views_SettingsPage_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Gemini2API_Views_SettingsPage[] = L"Gemini2API.Views.SettingsPage";
#endif
...
#ifndef ____x_Gemini2API_CViews_CISettingsPage_FWD_DEFINED__
#define ____x_Gemini2API_CViews_CISettingsPage_FWD_DEFINED__
typedef interface __x_Gemini2API_CViews_CISettingsPage __x_Gemini2API_CViews_CISettingsPage;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_Views_ISettingsPage[] = L"Gemini2API.Views.ISettingsPage";
/* [uuid("a54af139-1718-5f75-b108-13c0d3dd02d1"), version, object, exclusiveto] */
typedef struct __x_Gemini2API_CViews_CISettingsPageVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_Gemini2API_CViews_CISettingsPage * This,
...
} __x_Gemini2API_CViews_CISettingsPageVtbl;

interface __x_Gemini2API_CViews_CISettingsPage
{
    CONST_VTBL struct __x_Gemini2API_CViews_CISettingsPageVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_Gemini2API_CViews_CISettingsPage_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_Gemini2API_CViews_CISettingsPage_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_Gemini2API_CViews_CISettingsPage_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_Gemini2API_CViews_CISettingsPage_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_Gemini2API_CViews_CISettingsPage_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_Gemini2API_CViews_CISettingsPage_GetTrustLevel(This,trustLevel) \
