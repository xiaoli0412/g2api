/* Header file automatically generated from ModelsPage.idl */
/*
...
#ifndef __ModelsPage_h_h__
#define __ModelsPage_h_h__
#ifndef __ModelsPage_h_p_h__
#define __ModelsPage_h_p_h__
...
#ifndef ____x_Gemini2API_CViews_CIModelsPage_FWD_DEFINED__
#define ____x_Gemini2API_CViews_CIModelsPage_FWD_DEFINED__
...
#define __x_Gemini2API_CViews_CIModelsPage Gemini2API::Views::IModelsPage

#endif // ____x_Gemini2API_CViews_CIModelsPage_FWD_DEFINED__
...
/*
 *
 * Interface Gemini2API.Views.IModelsPage
 *
 * Interface is a part of the implementation of type Gemini2API.Views.ModelsPage
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Gemini2API.Views.IModelsPage:
 *
 *
 */
#if !defined(____x_Gemini2API_CViews_CIModelsPage_INTERFACE_DEFINED__)
#define ____x_Gemini2API_CViews_CIModelsPage_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_Views_IModelsPage[] = L"Gemini2API.Views.IModelsPage";

namespace Gemini2API {
    namespace Views {
        /* [uuid("c4cef6c7-704c-5dd0-8f92-8798bae76efa"), version, object, exclusiveto] */
        MIDL_INTERFACE("c4cef6c7-704c-5dd0-8f92-8798bae76efa")
        IModelsPage : public IInspectable
        {
        public:
            
        };

        MIDL_CONST_ID IID & IID_IModelsPage=__uuidof(IModelsPage);
        
    } /* Views */
} /* Gemini2API */

EXTERN_C const IID IID___x_Gemini2API_CViews_CIModelsPage;
#endif /* !defined(____x_Gemini2API_CViews_CIModelsPage_INTERFACE_DEFINED__) */


/*
 *
 * Class Gemini2API.Views.ModelsPage
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Gemini2API.Views.IModelsPage ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Gemini2API_Views_ModelsPage_DEFINED
#define RUNTIMECLASS_Gemini2API_Views_ModelsPage_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Gemini2API_Views_ModelsPage[] = L"Gemini2API.Views.ModelsPage";
#endif
...
#ifndef ____x_Gemini2API_CViews_CIModelsPage_FWD_DEFINED__
#define ____x_Gemini2API_CViews_CIModelsPage_FWD_DEFINED__
typedef interface __x_Gemini2API_CViews_CIModelsPage __x_Gemini2API_CViews_CIModelsPage;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_Views_IModelsPage[] = L"Gemini2API.Views.IModelsPage";
/* [uuid("c4cef6c7-704c-5dd0-8f92-8798bae76efa"), version, object, exclusiveto] */
typedef struct __x_Gemini2API_CViews_CIModelsPageVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_Gemini2API_CViews_CIModelsPage * This,
...
} __x_Gemini2API_CViews_CIModelsPageVtbl;

interface __x_Gemini2API_CViews_CIModelsPage
{
    CONST_VTBL struct __x_Gemini2API_CViews_CIModelsPageVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_Gemini2API_CViews_CIModelsPage_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_Gemini2API_CViews_CIModelsPage_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_Gemini2API_CViews_CIModelsPage_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_Gemini2API_CViews_CIModelsPage_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_Gemini2API_CViews_CIModelsPage_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_Gemini2API_CViews_CIModelsPage_GetTrustLevel(This,trustLevel) \
...
#endif // __ModelsPage_h_p_h__

#endif // __ModelsPage_h_h__
