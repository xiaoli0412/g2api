/* Header file automatically generated from ServerPage.idl */
/*
...
#ifndef __ServerPage_h_h__
#define __ServerPage_h_h__
#ifndef __ServerPage_h_p_h__
#define __ServerPage_h_p_h__
...
#ifndef ____x_Gemini2API_CViews_CIServerPage_FWD_DEFINED__
#define ____x_Gemini2API_CViews_CIServerPage_FWD_DEFINED__
...
#define __x_Gemini2API_CViews_CIServerPage Gemini2API::Views::IServerPage

#endif // ____x_Gemini2API_CViews_CIServerPage_FWD_DEFINED__
...
/*
 *
 * Interface Gemini2API.Views.IServerPage
 *
 * Interface is a part of the implementation of type Gemini2API.Views.ServerPage
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Gemini2API.Views.IServerPage:
 *
 *
 */
#if !defined(____x_Gemini2API_CViews_CIServerPage_INTERFACE_DEFINED__)
#define ____x_Gemini2API_CViews_CIServerPage_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_Views_IServerPage[] = L"Gemini2API.Views.IServerPage";

namespace Gemini2API {
    namespace Views {
        /* [uuid("a78559d7-aecd-5bac-bb0a-b27d2819ca60"), version, object, exclusiveto] */
        MIDL_INTERFACE("a78559d7-aecd-5bac-bb0a-b27d2819ca60")
        IServerPage : public IInspectable
        {
        public:
            
        };

        MIDL_CONST_ID IID & IID_IServerPage=__uuidof(IServerPage);
        
    } /* Views */
} /* Gemini2API */

EXTERN_C const IID IID___x_Gemini2API_CViews_CIServerPage;
#endif /* !defined(____x_Gemini2API_CViews_CIServerPage_INTERFACE_DEFINED__) */


/*
 *
 * Class Gemini2API.Views.ServerPage
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Gemini2API.Views.IServerPage ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Gemini2API_Views_ServerPage_DEFINED
#define RUNTIMECLASS_Gemini2API_Views_ServerPage_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Gemini2API_Views_ServerPage[] = L"Gemini2API.Views.ServerPage";
#endif
...
#ifndef ____x_Gemini2API_CViews_CIServerPage_FWD_DEFINED__
#define ____x_Gemini2API_CViews_CIServerPage_FWD_DEFINED__
typedef interface __x_Gemini2API_CViews_CIServerPage __x_Gemini2API_CViews_CIServerPage;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_Views_IServerPage[] = L"Gemini2API.Views.IServerPage";
/* [uuid("a78559d7-aecd-5bac-bb0a-b27d2819ca60"), version, object, exclusiveto] */
typedef struct __x_Gemini2API_CViews_CIServerPageVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_Gemini2API_CViews_CIServerPage * This,
...
} __x_Gemini2API_CViews_CIServerPageVtbl;

interface __x_Gemini2API_CViews_CIServerPage
{
    CONST_VTBL struct __x_Gemini2API_CViews_CIServerPageVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_Gemini2API_CViews_CIServerPage_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_Gemini2API_CViews_CIServerPage_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_Gemini2API_CViews_CIServerPage_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_Gemini2API_CViews_CIServerPage_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_Gemini2API_CViews_CIServerPage_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_Gemini2API_CViews_CIServerPage_GetTrustLevel(This,trustLevel) \
...
#endif // __ServerPage_h_p_h__

#endif // __ServerPage_h_h__
