/* Header file automatically generated from LogsPage.idl */
/*
...
#ifndef __LogsPage_h_h__
#define __LogsPage_h_h__
#ifndef __LogsPage_h_p_h__
#define __LogsPage_h_p_h__
...
#ifndef ____x_Gemini2API_CViews_CILogsPage_FWD_DEFINED__
#define ____x_Gemini2API_CViews_CILogsPage_FWD_DEFINED__
...
#define __x_Gemini2API_CViews_CILogsPage Gemini2API::Views::ILogsPage

#endif // ____x_Gemini2API_CViews_CILogsPage_FWD_DEFINED__
...
/*
 *
 * Interface Gemini2API.Views.ILogsPage
 *
 * Interface is a part of the implementation of type Gemini2API.Views.LogsPage
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Gemini2API.Views.ILogsPage:
 *
 *
 */
#if !defined(____x_Gemini2API_CViews_CILogsPage_INTERFACE_DEFINED__)
#define ____x_Gemini2API_CViews_CILogsPage_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_Views_ILogsPage[] = L"Gemini2API.Views.ILogsPage";

namespace Gemini2API {
    namespace Views {
        /* [uuid("666f998b-9002-592c-a959-1f83e606837c"), version, object, exclusiveto] */
        MIDL_INTERFACE("666f998b-9002-592c-a959-1f83e606837c")
        ILogsPage : public IInspectable
        {
        public:
            
        };

        MIDL_CONST_ID IID & IID_ILogsPage=__uuidof(ILogsPage);
        
    } /* Views */
} /* Gemini2API */

EXTERN_C const IID IID___x_Gemini2API_CViews_CILogsPage;
#endif /* !defined(____x_Gemini2API_CViews_CILogsPage_INTERFACE_DEFINED__) */


/*
 *
 * Class Gemini2API.Views.LogsPage
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Gemini2API.Views.ILogsPage ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Gemini2API_Views_LogsPage_DEFINED
#define RUNTIMECLASS_Gemini2API_Views_LogsPage_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Gemini2API_Views_LogsPage[] = L"Gemini2API.Views.LogsPage";
#endif
...
#ifndef ____x_Gemini2API_CViews_CILogsPage_FWD_DEFINED__
#define ____x_Gemini2API_CViews_CILogsPage_FWD_DEFINED__
typedef interface __x_Gemini2API_CViews_CILogsPage __x_Gemini2API_CViews_CILogsPage;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_Views_ILogsPage[] = L"Gemini2API.Views.ILogsPage";
/* [uuid("666f998b-9002-592c-a959-1f83e606837c"), version, object, exclusiveto] */
typedef struct __x_Gemini2API_CViews_CILogsPageVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_Gemini2API_CViews_CILogsPage * This,
...
} __x_Gemini2API_CViews_CILogsPageVtbl;

interface __x_Gemini2API_CViews_CILogsPage
{
    CONST_VTBL struct __x_Gemini2API_CViews_CILogsPageVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_Gemini2API_CViews_CILogsPage_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_Gemini2API_CViews_CILogsPage_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_Gemini2API_CViews_CILogsPage_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_Gemini2API_CViews_CILogsPage_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_Gemini2API_CViews_CILogsPage_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_Gemini2API_CViews_CILogsPage_GetTrustLevel(This,trustLevel) \
...
#endif // __LogsPage_h_p_h__

#endif // __LogsPage_h_h__
