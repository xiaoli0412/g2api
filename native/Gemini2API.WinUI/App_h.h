...
#ifndef ____x_Gemini2API_CIApp_FWD_DEFINED__
#define ____x_Gemini2API_CIApp_FWD_DEFINED__

namespace Gemini2API {
    interface IApp;
} /* Gemini2API */
#define __x_Gemini2API_CIApp Gemini2API::IApp

#endif // ____x_Gemini2API_CIApp_FWD_DEFINED__
...
/*
 *
 * Interface Gemini2API.IApp
 *
 * Interface is a part of the implementation of type Gemini2API.App
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Gemini2API.IApp:
 *
 *
 */
#if !defined(____x_Gemini2API_CIApp_INTERFACE_DEFINED__)
#define ____x_Gemini2API_CIApp_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_IApp[] = L"Gemini2API.IApp";

namespace Gemini2API {
    /* [uuid("42bd5e23-c255-5e9d-9871-eda55809316b"), version, object, exclusiveto] */
    MIDL_INTERFACE("42bd5e23-c255-5e9d-9871-eda55809316b")
...
EXTERN_C const IID IID___x_Gemini2API_CIApp;
#endif /* !defined(____x_Gemini2API_CIApp_INTERFACE_DEFINED__) */


/*
 *
 * Class Gemini2API.App
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Gemini2API.IApp ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Gemini2API_App_DEFINED
#define RUNTIMECLASS_Gemini2API_App_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Gemini2API_App[] = L"Gemini2API.App";
#endif
...
#ifndef ____x_Gemini2API_CIApp_FWD_DEFINED__
#define ____x_Gemini2API_CIApp_FWD_DEFINED__
typedef interface __x_Gemini2API_CIApp __x_Gemini2API_CIApp;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_IApp[] = L"Gemini2API.IApp";
/* [uuid("42bd5e23-c255-5e9d-9871-eda55809316b"), version, object, exclusiveto] */
typedef struct __x_Gemini2API_CIAppVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_Gemini2API_CIApp * This,
...
} __x_Gemini2API_CIAppVtbl;

interface __x_Gemini2API_CIApp
{
    CONST_VTBL struct __x_Gemini2API_CIAppVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_Gemini2API_CIApp_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_Gemini2API_CIApp_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_Gemini2API_CIApp_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_Gemini2API_CIApp_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_Gemini2API_CIApp_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_Gemini2API_CIApp_GetTrustLevel(This,trustLevel) \
