...
#ifndef ____x_Gemini2API_CIMainWindow_FWD_DEFINED__
#define ____x_Gemini2API_CIMainWindow_FWD_DEFINED__

namespace Gemini2API {
    interface IMainWindow;
} /* Gemini2API */
#define __x_Gemini2API_CIMainWindow Gemini2API::IMainWindow

#endif // ____x_Gemini2API_CIMainWindow_FWD_DEFINED__
...
/*
 *
 * Interface Gemini2API.IMainWindow
 *
 * Interface is a part of the implementation of type Gemini2API.MainWindow
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Gemini2API.IMainWindow:
 *
 *
 */
#if !defined(____x_Gemini2API_CIMainWindow_INTERFACE_DEFINED__)
#define ____x_Gemini2API_CIMainWindow_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_IMainWindow[] = L"Gemini2API.IMainWindow";

namespace Gemini2API {
    /* [uuid("6e1b571b-e25a-5a55-9ad8-427e54c82db0"), version, object, exclusiveto] */
    MIDL_INTERFACE("6e1b571b-e25a-5a55-9ad8-427e54c82db0")
...
EXTERN_C const IID IID___x_Gemini2API_CIMainWindow;
#endif /* !defined(____x_Gemini2API_CIMainWindow_INTERFACE_DEFINED__) */


/*
 *
 * Class Gemini2API.MainWindow
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Gemini2API.IMainWindow ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Gemini2API_MainWindow_DEFINED
#define RUNTIMECLASS_Gemini2API_MainWindow_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Gemini2API_MainWindow[] = L"Gemini2API.MainWindow";
#endif
...
#ifndef ____x_Gemini2API_CIMainWindow_FWD_DEFINED__
#define ____x_Gemini2API_CIMainWindow_FWD_DEFINED__
typedef interface __x_Gemini2API_CIMainWindow __x_Gemini2API_CIMainWindow;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_IMainWindow[] = L"Gemini2API.IMainWindow";
/* [uuid("6e1b571b-e25a-5a55-9ad8-427e54c82db0"), version, object, exclusiveto] */
typedef struct __x_Gemini2API_CIMainWindowVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_Gemini2API_CIMainWindow * This,
...
} __x_Gemini2API_CIMainWindowVtbl;

interface __x_Gemini2API_CIMainWindow
{
    CONST_VTBL struct __x_Gemini2API_CIMainWindowVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_Gemini2API_CIMainWindow_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_Gemini2API_CIMainWindow_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_Gemini2API_CIMainWindow_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_Gemini2API_CIMainWindow_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_Gemini2API_CIMainWindow_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_Gemini2API_CIMainWindow_GetTrustLevel(This,trustLevel) \
