/* Header file automatically generated from CookiesPage.idl */
/*
...
#ifndef __CookiesPage_h_h__
#define __CookiesPage_h_h__
#ifndef __CookiesPage_h_p_h__
#define __CookiesPage_h_p_h__
...
#ifndef ____x_Gemini2API_CViews_CICookiesPage_FWD_DEFINED__
#define ____x_Gemini2API_CViews_CICookiesPage_FWD_DEFINED__

namespace Gemini2API {
    namespace Views {
        interface ICookiesPage;
    } /* Views */
} /* Gemini2API */
#define __x_Gemini2API_CViews_CICookiesPage Gemini2API::Views::ICookiesPage

#endif // ____x_Gemini2API_CViews_CICookiesPage_FWD_DEFINED__
...
/*
 *
 * Interface Gemini2API.Views.ICookiesPage
 *
 * Interface is a part of the implementation of type Gemini2API.Views.CookiesPage
 *
 *
 * The IID for this interface was automatically generated by MIDLRT.
 *
 * Interface IID generation seed: Gemini2API.Views.ICookiesPage:
 *
 *
 */
#if !defined(____x_Gemini2API_CViews_CICookiesPage_INTERFACE_DEFINED__)
#define ____x_Gemini2API_CViews_CICookiesPage_INTERFACE_DEFINED__
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_Views_ICookiesPage[] = L"Gemini2API.Views.ICookiesPage";

namespace Gemini2API {
    namespace Views {
        /* [uuid("f9e49dae-3602-5d62-9e58-78e3068bd878"), version, object, exclusiveto] */
        MIDL_INTERFACE("f9e49dae-3602-5d62-9e58-78e3068bd878")
        ICookiesPage : public IInspectable
        {
        public:
            
        };

        MIDL_CONST_ID IID & IID_ICookiesPage=__uuidof(ICookiesPage);
        
    } /* Views */
} /* Gemini2API */

EXTERN_C const IID IID___x_Gemini2API_CViews_CICookiesPage;
#endif /* !defined(____x_Gemini2API_CViews_CICookiesPage_INTERFACE_DEFINED__) */


/*
 *
 * Class Gemini2API.Views.CookiesPage
 *
 * RuntimeClass can be activated.
 *
 * Class implements the following interfaces:
 *    Gemini2API.Views.ICookiesPage ** Default Interface **
 *
...
#ifndef RUNTIMECLASS_Gemini2API_Views_CookiesPage_DEFINED
#define RUNTIMECLASS_Gemini2API_Views_CookiesPage_DEFINED
extern const __declspec(selectany) _Null_terminated_ WCHAR RuntimeClass_Gemini2API_Views_CookiesPage[] = L"Gemini2API.Views.CookiesPage";
#endif
...
#ifndef ____x_Gemini2API_CViews_CICookiesPage_FWD_DEFINED__
#define ____x_Gemini2API_CViews_CICookiesPage_FWD_DEFINED__
typedef interface __x_Gemini2API_CViews_CICookiesPage __x_Gemini2API_CViews_CICookiesPage;
...
extern const __declspec(selectany) _Null_terminated_ WCHAR InterfaceName_Gemini2API_Views_ICookiesPage[] = L"Gemini2API.Views.ICookiesPage";
/* [uuid("f9e49dae-3602-5d62-9e58-78e3068bd878"), version, object, exclusiveto] */
typedef struct __x_Gemini2API_CViews_CICookiesPageVtbl
{
    BEGIN_INTERFACE
    HRESULT ( STDMETHODCALLTYPE *QueryInterface)(
    __RPC__in __x_Gemini2API_CViews_CICookiesPage * This,
...
} __x_Gemini2API_CViews_CICookiesPageVtbl;

interface __x_Gemini2API_CViews_CICookiesPage
{
    CONST_VTBL struct __x_Gemini2API_CViews_CICookiesPageVtbl *lpVtbl;
};

#ifdef COBJMACROS
#define __x_Gemini2API_CViews_CICookiesPage_QueryInterface(This,riid,ppvObject) \
( (This)->lpVtbl->QueryInterface(This,riid,ppvObject) )

#define __x_Gemini2API_CViews_CICookiesPage_AddRef(This) \
        ( (This)->lpVtbl->AddRef(This) )

#define __x_Gemini2API_CViews_CICookiesPage_Release(This) \
        ( (This)->lpVtbl->Release(This) )

#define __x_Gemini2API_CViews_CICookiesPage_GetIids(This,iidCount,iids) \
        ( (This)->lpVtbl->GetIids(This,iidCount,iids) )

#define __x_Gemini2API_CViews_CICookiesPage_GetRuntimeClassName(This,className) \
        ( (This)->lpVtbl->GetRuntimeClassName(This,className) )

#define __x_Gemini2API_CViews_CICookiesPage_GetTrustLevel(This,trustLevel) \
...
#endif // __CookiesPage_h_p_h__

#endif // __CookiesPage_h_h__
